...
[Route("api/v1/games")]
public class V1GamesController : ControllerBase
{
	private readonly IGameRepository _gameRepository;
	private readonly IMapper _mapper;

	public V1GamesController(IGameRepository gameRepository, IMapper mapper)
	{
	...
	public async Task<ActionResult<List<Game>>> GetGames()
	{
		...
		List<V1GameDto> gameDtos = _mapper.Map<List<V1GameDto>>(games);
	...
	public async Task<ActionResult<Game>> GetGame(int id)
	{
		...
		var gameDto = _mapper.Map<V1GameDto>(game);
